...
import { mockUserStats, mockDomainProgress, heatmapData } from '../data/mockData';
  ...
  return (
    <div className="h-[calc(100vh-180px)] overflow-y-auto pr-1">
      ...
      >
        <StatCard
          icon={BookOpen}
          value={mockUserStats.conceptsLearned}
          label="Concepts"
          color="#B6FF2E"
        />
        <StatCard
          icon={FileText}
          value={mockUserStats.notesAdded}
          label="Notes"
          color="#2EFFE6"
        />
        <StatCard
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h3 className="font-heading font-semibold text-white mb-3">Learning Progress</h3>
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h3 className="font-heading font-semibold text-white mb-3">Activity</h3>
        <div className="glass-surface rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-xs text-white/40">Jan</span>
          </div>
